...
-- Hàm BringEnemy
-- [[ 1. KHAI BÁO DANH SÁCH BOSS CẦN NÉ (Đã đổi tên biến để không trùng) ]] --
local PlaceId = game.PlaceId
local AntiBossList = {} -- Đặt tên khác đi (AntiBossList) thay vì Boss

if PlaceId == 2753915549 or PlaceId == 85211729168715 or PlaceId == 73902483975735 then
    -- World 1
    AntiBossList = {
...
elseif PlaceId == 4442272183 or PlaceId == 79091703265657 or PlaceId == 73902483975735 then
    -- World 2
    AntiBossList = {
        "Diamond", "Jeremy", "Fajita", "Don Swan", "Smoke Admiral", 
        "Awakened Ice Admiral", "Tide Keeper", "Darkbeard", "Cursed Captain", 
        "Order"
    }
elseif PlaceId == 7449423635 or PlaceId == 85211729168715 or PlaceId == 73902483975735 then
    -- World 3
    AntiBossList = {
...
BringEnemy = function()
    ...
    for _,v in pairs(workspace.Enemies:GetChildren()) do
        if v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
            ...
            -- [[ QUAN TRỌNG: Check tên trong danh sách AntiBossList ]] --
            if table.find(AntiBossList, v.Name) then
                continue -- Nếu tên có trong list Anti thì bỏ qua
            end
...
Window = Library:CreateWindow({
    Title = "NatAov Hub",
    Subtitle = "- Blox Fruit",
    Image = "rbxassetid://89123391788498"
})
