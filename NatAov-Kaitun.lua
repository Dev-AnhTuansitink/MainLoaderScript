...
-- Hàm giải mã tên (giữ nguyên)
function L_1_[3](t)
	local res = ""
	for _,v in pairs(t) do res = res .. v end
	return res
end

if L_1_[43]:FindFirstChild("Status_UI_Tech") then
	L_1_[43]["Status_UI_Tech"]:Destroy()
end

L_1_[11] = Instance["new"]("ScreenGui")
L_1_[11]["Name"] = "Status_UI_Tech"
L_1_[11]["ResetOnSpawn"] = false
L_1_[11]["Parent"] = L_1_[43]

-- Main Frame
L_1_[42] = Instance["new"]("Frame")
L_1_[42]["Size"] = UDim2["new"](0, 450, 0, 75)
L_1_[42]["Position"] = UDim2["new"](.5, 0, -0.2, 0) -- Bắt đầu ở trên cao
L_1_[42]["AnchorPoint"] = Vector2["new"](.5, 0)
L_1_[42]["BackgroundColor3"] = Color3["fromRGB"](10, 15, 25) -- Màu nền xanh đen đậm
L_1_[42]["ClipsDescendants"] = true -- Cắt phần thừa của hiệu ứng quét
L_1_[42]["BorderSizePixel"] = 0
L_1_[42]["Parent"] = L_1_[11]

-- [MỚI] Hiệu ứng lưới Grid nền
L_1_[60] = Instance["new"]("ImageLabel")
L_1_[60]["Size"] = UDim2["new"](1, 0, 1, 0)
L_1_[60]["BackgroundTransparency"] = 1
L_1_[60]["Image"] = "rbxassetid://3570695787" -- Texture lưới lục giác
L_1_[60]["ImageColor3"] = Color3["fromRGB"](0, 255, 255)
L_1_[60]["ImageTransparency"] = 0.92
L_1_[60]["ScaleType"] = Enum["ScaleType"]["Tile"]
L_1_[60]["TileSize"] = UDim2["new"](0, 30, 0, 30)
L_1_[60]["Parent"] = L_1_[42]

-- UICorner
L_1_[41] = Instance["new"]("UICorner")
L_1_[41]["CornerRadius"] = UDim["new"](0, 8)
L_1_[41]["Parent"] = L_1_[42]

-- UIStroke (Viền)
L_1_[12] = Instance["new"]("UIStroke")
L_1_[12]["Thickness"] = 2.5
L_1_[12]["Color"] = Color3["fromRGB"](0, 255, 255) -- Màu gốc Cyan
L_1_[12]["ApplyStrokeMode"] = Enum["ApplyStrokeMode"]["Border"]
L_1_[12]["Parent"] = L_1_[42]

-- Tiêu đề
L_1_[15] = Instance["new"]("TextLabel")
L_1_[15]["Size"] = UDim2["new"](1, -50, .4, 0)
L_1_[15]["Position"] = UDim2["new"](.5, -20, 0.15, 0)
L_1_[15]["AnchorPoint"] = Vector2["new"](.5, 0)
L_1_[15][L_1_[3]({
	"BackgroundTransparen",
	"cy"
})] = 1
L_1_[15]["Text"] = "SYSTEM: TUANAOV HUB"
L_1_[15]["TextColor3"] = Color3["fromRGB"](0, 255, 255)
L_1_[15]["TextSize"] = 20
L_1_[15]["Font"] = Enum["Font"]["GothamBold"] -- Font dày
L_1_[15]["TextXAlignment"] = Enum["TextXAlignment"]["Left"]
L_1_[15]["Parent"] = L_1_[42]

-- Status
L_1_[26] = Instance["new"]("TextLabel")
L_1_[26]["Size"] = UDim2["new"](1, -50, .4, 0)
L_1_[26]["Position"] = UDim2["new"](.5, -20, 0.55, 0)
L_1_[26]["AnchorPoint"] = Vector2["new"](.5, 0)
L_1_[26][L_1_[3]({
	"BackgroundTransparen";
	"cy"
})] = 1
L_1_[26]["Text"] = "> Status: Connecting..."
L_1_[26]["TextColor3"] = Color3["fromRGB"](0, 150, 255)
L_1_[26]["TextSize"] = 15
L_1_[26]["Font"] = Enum["Font"]["GothamMedium"]
L_1_[26]["TextXAlignment"] = Enum["TextXAlignment"]["Left"]
L_1_[26]["Parent"] = L_1_[42]

-- [MỚI] Icon xoay trang trí bên phải
L_1_[62] = Instance["new"]("ImageLabel")
L_1_[62]["Size"] = UDim2["new"](0, 45, 0, 45)
L_1_[62]["Position"] = UDim2["new"](0.92, 0, 0.5, 0)
L_1_[62]["AnchorPoint"] = Vector2["new"](0.5, 0.5)
L_1_[62]["BackgroundTransparency"] = 1
L_1_[62]["Image"] = "rbxassetid://7072729817" -- Hình tròn HUD
L_1_[62]["ImageColor3"] = Color3["fromRGB"](0, 255, 255)
L_1_[62]["Parent"] = L_1_[42]

-- [MỚI] Vạch quét Lazer (Scan Line)
L_1_[61] = Instance["new"]("Frame")
L_1_[61]["Size"] = UDim2["new"](0, 2, 1.5, 0)
L_1_[61]["Position"] = UDim2["new"](-0.1, 0, 0.5, 0)
L_1_[61]["AnchorPoint"] = Vector2["new"](0.5, 0.5)
L_1_[61]["BackgroundColor3"] = Color3["fromRGB"](255, 255, 255)
L_1_[61]["BackgroundTransparency"] = 0.5
L_1_[61]["Rotation"] = 20
L_1_[61]["BorderSizePixel"] = 0
L_1_[61]["Parent"] = L_1_[42]

task["spawn"](function()
	-- 1. Animation trượt xuống mở đầu
	local intro = L_1_[6]:Create(L_1_[42], TweenInfo["new"](1, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
		["Position"] = UDim2["new"](.5, 0, .07, 0)
	})
	intro:Play()
	intro.Completed:Wait()
	
	-- 2. Chạy hiệu ứng phụ (Icon xoay + Quét Lazer)
	task.spawn(function()
		local rot = 0
		while true do
			rot = rot + 2
			L_1_[62]["Rotation"] = rot -- Xoay icon
			
			-- Logic quét lazer
			if rot % 180 == 0 then -- Cứ mỗi khoảng thời gian thì quét 1 lần
				L_1_[61]["Position"] = UDim2["new"](-0.1, 0, 0.5, 0)
				local scan = L_1_[6]:Create(L_1_[61], TweenInfo["new"](2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
	...
	-- 3. Vòng lặp đổi màu (Pulse/Breathing) như code cũ bạn yêu cầu
	while task["wait"]() do
		local L_27_ = {}
		local ColorBright = Color3["fromRGB"](150, 255, 255) -- Màu sáng
		local ColorDark = Color3["fromRGB"](0, 140, 255)     -- Màu tối
		...
		L_27_[3] = L_1_[6]:Create(L_1_[15], TweenInfo["new"](1.2), {
			["TextColor3"] = ColorDark
		})
		L_27_[7] = L_1_[6]:Create(L_1_[26], TweenInfo["new"](1.2), {
			["TextColor3"] = ColorDark
		})

		-- Chạy theo thứ tự như code gốc
		L_27_[4]:Play()
		L_27_[2]:Play()
		L_27_[1]:Play()
