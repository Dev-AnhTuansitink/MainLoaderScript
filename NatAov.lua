...
local e = (loadstring(game:HttpGet("https://raw.githubusercontent.com/Dev-AnhTuansitink/Ui_vip_pro/refs/heads/main/skibidi_ui.lua")))();
if World1 then
	Boss = {
			"The Gorilla King",
			"Bobby",
