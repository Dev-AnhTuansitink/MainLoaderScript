...
Title.Text = "NatAov Hub Đã Nâng Cấp"
...
Content.Text = "VUI LÒNG VÀO DISCORD ĐỂ LẤY SCRIPT MỚI NHẤT !!"
...
Button.MouseButton1Click:Connect(function()
    if setclipboard then
        setclipboard("https://discord.gg/UefGEBySJ8")
